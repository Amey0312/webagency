...
const Navbar = () => {
  ...
  useGSAP(
    ...
    { dependencies: [isOpen] } // Trigger animation on toggle
  );
 ...
 useEffect(() => {
  ...
  return (
    <nav ref={navRef} className="bg-[#28293E] fixed w-full z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div  className="flex justify-between h-16 items-center">
          <div  className="text-2xl font-bold text-white p-4">
            <svg width="152" height="48" viewBox="0 0 152 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clip-path="url(#clip0_0_45)">
                ...
                <path d="M43.8857 17.5381L36.291 40.916H11.709L4.11328 17.5381L24 3.08984L43.8857 17.5381Z" stroke="#EF6D58" stroke-width="5" />
                <path d="M23.5 14L32.535 20.5643L29.084 31.1857H17.916L14.465 20.5643L23.5 14Z" fill="#EF6D58" />
              </g>
              <defs>
          ...
          {/* Desktop Links */}
          <div className="hidden epilogue md:flex  space-x-20 ">
            <a href="#" className="text-white hover:text-[#EF6D58] text">About</a>
            <a href="#" className="text-white hover:text-[#EF6D58] text">Services</a>
            <a href="#" className="text-white hover:text-[#EF6D58] text">Pricing</a>
            <a href="#" className="text-white hover:text-[#EF6D58] text">Blog</a>
          </div>
          <button className="hidden contact md:flex text-white border b-white rounded-xl px-4 p-3  hover:bg-white hover:text-[#EF6D58]">
            Contact
          </button>

          {/* Mobile Menu Icon */}
          <div className="md:hidden m-4">
            <button onClick={toggleMenu} className="text-white focus:outline-1">
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div ref={menuRef} className="md:hidden h-screen flex epilogue flex-col items-center justify-center bg-[#28293E] px-4  pb-4 space-y-10 shadow-md">
          <a href="#" className="text-white text-center hover:text-[#EF6D58]  text">About</a>
          <a href="#" className="text-white text-center hover:text-[#EF6D58] text">Services</a>
          <a href="#" className="text-white text-center hover:text-[#EF6D58] text">Pricing</a>
          <a href="#" className="text-white text-center hover:text-[#EF6D58] text">Blog</a>
          <button className=" text-white border b-white rounded-xl px-5 p-3 hover:bg-white hover:text-[#EF6D58]">
            Contact
          </button>
        </div>
